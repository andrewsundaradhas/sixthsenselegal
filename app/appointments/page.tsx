                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="name" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Full Name</label>
                        <Input id="name" name="name" type="text" placeholder="John Doe" required className="h-10 sm:h-11" />
                      </div>
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="email" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Email</label>
                        <Input id="email" name="email" type="email" placeholder="john.doe@example.com" required className="h-10 sm:h-11" />
                      </div>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="phone" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Phone Number</label>
                        <Input id="phone" name="phone" type="text" placeholder="+91 98765 43210" required className="h-10 sm:h-11" />
                      </div>
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="serviceType" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Service Type</label>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="date" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Preferred Date</label>
                      ...
                      <div className="form-field-focus sm:col-span-1">
                        <label htmlFor="time" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Preferred Time</label>
                    ...
                    <div className="form-field-focus">
                      <label htmlFor="message" className="block mb-1.5 sm:mb-2 text-sm sm:text-base">Additional Information</label>
